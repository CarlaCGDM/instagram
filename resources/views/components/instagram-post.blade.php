    ...
    <div class="bg-white border rounded-sm max-w-md">
        ...
        <div class="flex items-center justify-between mx-4 mt-2 mb-2">
            <div class="flex gap-5">
                <!--formulario del like-->
                <form>
                    <button class="submit-button" data-user-id="{{ auth()->id() }}" data-image-id="{{ $image_id }}">
            ...
            <div class="flex">
                <div id="like_count_{{ $image_id }}" class="font-semibold text-xs mt-2 mb-2">{{ $likes }} likes</div>
            </div>
        </div>
    </div>
</div>

...
<div class="bg-gray-100 p-4">
    <div class="bg-white border rounded-sm max-w-md">
        ...
        <div class="flex items-center px-4 py-3">
            ...
            <div class="ml-3 ">
                <button type="submit"><span class="text-sm font-semibold antialiased block leading-tight">{{ $nick }}</span></button>
        ...
        <div class="flex items-center justify-between mx-4 mt-2 mb-2">
            ...
            <div class="flex">
                <div class="font-semibold text-xs mt-2 mb-2">{{ $likes }} likes</div>
            </div>
        </div>
    </div>
</div>

...
<div class="relative text-lg bg-transparent text-gray-800">
  <form method="GET" action="{{ route('users.index') }}" class="flex items-center border-b-2 border-blue-500 py-2">
	<input  style="width:95vw;" class="bg-transparent border-none mr-3 px-2 leading-tight focus:outline-none focus:border-transparent focus:ring-0" type="text" placeholder="Buscar" name="filter">
